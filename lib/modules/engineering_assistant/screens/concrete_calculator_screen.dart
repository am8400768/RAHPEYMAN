...
class _ConcreteCalculatorScreenState extends State<ConcreteCalculatorScreen> {
  ...
  void _updateCementPrice(String value) {
    final cursorPosition = _cementPriceController.selection.baseOffset;
  ...
  void _updateAggregatePrice(String value) {
    final cursorPosition = _aggregatePriceController.selection.baseOffset;
      ...
      child: Column(
        children: [
            ...
            children: [
              Expanded(
                child: _buildCostHero(
                  ...
                  value: unitCost == null ? '—' : _formatPrice(unitCost),
                ),
              ),
              const SizedBox(width: 10),
              Expanded(
                child: _buildCostHero(
                  title: 'جمع کل',
                  value: totalCost == null ? '—' : _formatPrice(totalCost),
                  grand: true,
                ),
              ),
            ],
          ...
          _buildBreakdownRow(
            ...
            cementCost == null ? '—' : _formatPrice(cementCost),
          ),
          const SizedBox(height: 7),
          _buildBreakdownRow(
            'شن و ماسه (${aggregate == null ? '—' : _formatNumber(aggregate, decimals: 2)} تن)',
            aggregateCost == null ? '—' : _formatPrice(aggregateCost),
          ),
        ],
      ),
    );
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontSize: hero ? 18 : 16,
              fontWeight: FontWeight.w800,
              color: hero ? _concreteColor : EstefsariehColors.primary,
            ),
          ),
          const SizedBox(height: 2),
          Text(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight: FontWeight.w800,
              color: grand ? _concreteColor : EstefsariehColors.primary,
            ),
          ),
          const SizedBox(height: 2),
          const Text(
