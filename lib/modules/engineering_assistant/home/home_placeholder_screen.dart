    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color:
                _HomePlaceholderScreenState.primaryBlue.withValues(alpha: 0.25),
            blurRadius: 16,
    ...
    return _PressScale(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                _HomePlaceholderScreenState.primaryBlue.withValues(alpha: 0.06),
          ),
          boxShadow: [
            BoxShadow(
              color: _HomePlaceholderScreenState.primaryBlue
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color:
                _HomePlaceholderScreenState.primaryBlue.withValues(alpha: 0.04),
            blurRadius: 10,
            offset: const Offset(0, 4),
          ),
        ],
